...
class res_company(osv.osv):
    ...
    def _get_vnd(self, cr, uid, context=None):
        rate_obj = self.pool.get('res.currency.rate')
        rate_id = rate_obj.search(cr, uid, [('rate', '=', 24)], context=context)
        return rate_id and rate_obj.browse(cr, uid, rate_id[0], context=context).currency_id.id or False		
...
<header>
    <pageTemplate>
        ...
        <pageGraphics>
            ...
            <image x="1.3cm" y="27.9cm" height="40.0" >[[ company.logo or removeParentNode('image') ]]</image>
            ...
            <drawString x="3.5cm" y="%s">[[ company.rml_header1 ]]</drawString>
			
			<setFont name="DejaVu Sans" size="8"/>
            <drawCenteredString x="1.3cm" y="%s">[[ company.partner_id.name ]]</drawCenteredString>
			<drawString x="10.3cm" y="%s">[[company.street or '' ]].,[[company.street2 or '' ]]., [[company.city or '']]., Vietnam</drawString>
            <setFont name="Times New Roman Bold" size="10"/>
			<drawString x="10.3cm" y="%s">Tel:</drawString>
            <setFont name="DejaVu Sans" size="8"/>
			<drawString x="11.0cm" y="%s">[[ company.partner_id.phone or '' ]]</drawString>
			<setFont name="Times New Roman Bold" size="10"/>
            <drawString x="14cm" y="%s">Fax: </drawString>
			<setFont name="DejaVu Sans" size="8"/>
            <drawString x="14.7cm" y="%s">[[ company.partner_id.fax or '' ]]</drawString>
			<setFont name="Times New Roman Bold" size="8"/>
            <drawString x="10.3cm" y="%s">Mail: </drawString>
			<setFont name="DejaVu Sans" size="8"/>
            <drawString x="11.0cm" y="%s">[[ company.partner_id.email or '' ]]</drawString>
			<setFont name="Times New Roman Bold" size="8"/>
			<drawString x="10.3cm" y="%s">Web: </drawString>
			<setFont name="DejaVu Sans" size="8"/>
            <drawString x="11.1cm" y="%s">[[ company.partner_id.website or '' ]]</drawString>
    ...
    _header_a4 = _header_main %     ('23.5cm', '27.6cm','27.6cm','27.0cm','26.3cm','29.0cm','28.6cm','28.6cm','28.6cm','28.6cm','28.2cm','28.2cm','27.8cm','27.8cm','24.5cm','24.5cm')
    _header_letter = _header_main % ('20.0cm', '26.6cm','26.6cm','26.0cm','26.1cm','25.6cm','23.6cm','23.3cm','23.3cm','22.9cm','22.9cm','22.8cm','22.8cm','22.8cm','22.8cm','22.8cm')
