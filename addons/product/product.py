...
class product_packaging(osv.osv):
    def _calc_volume(self, cr, uid, ids, fields, arg, context=None):
        _pkg = self.browse(cr, uid, ids)[0]
        total= _pkg.height * _pkg.length * _pkg.width
        print total
        return total
    ...
    _columns = {
       ...
       # 'volume': fields.function(_calc_volume, store=True, type='float', string='Package Volume'),
    }
